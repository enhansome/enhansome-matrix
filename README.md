...
* [Element](https://element.io) - A glossy client with an emphasis on
  performance and usability. ([Web](https://github.com/vector-im/element-web) ⭐ 13,448 | 🐛 3,777 | 🌐 TypeScript | 📅 2026-09-12,
  [iOS](https://github.com/vector-im/element-ios) ⭐ 1,842 | 🐛 1,762 | 🌐 Swift | 📅 2026-09-11,
  [Android](https://github.com/vector-im/element-android) ⭐ 3,728 | 🐛 2,217 | 🌐 Kotlin | 📅 2026-09-10) `Apache-2.0`
  `TypeScript`, `Swift`, `Kotlin`
* [FluffyChat](https://github.com/krille-chan/fluffychat) ⭐ 3,117 | 🐛 557 | 🌐 Dart | 📅 2026-09-12 - Cute instant messaging
...
* [Matrix CRDT](https://github.com/yousefED/matrix-crdt) ⭐ 784 | 🐛 8 | 🌐 TypeScript | 📅 2024-03-27 - Integrates CRDTs like
  [Yjs](https://github.com/yjs/yjs) ⭐ 22,783 | 🐛 138 | 🌐 JavaScript | 📅 2026-09-07 with Matrix for storage and sync. `MPL-2.0`
  `TypeScript`
...
* [matrix-rust-sdk](https://github.com/matrix-org/matrix-rust-sdk) ⭐ 2,290 | 🐛 322 | 🌐 Rust | 📅 2026-09-11 - A modular

...
* [Element](https://element.io) - A glossy client with an emphasis on
  performance and usability. ([Web](https://github.com/vector-im/element-web) ⭐ 13,424 | 🐛 3,822 | 🌐 TypeScript | 📅 2026-09-03,
  [iOS](https://github.com/vector-im/element-ios) ⭐ 1,842 | 🐛 1,759 | 🌐 Swift | 📅 2026-06-23,
  [Android](https://github.com/vector-im/element-android) ⭐ 3,724 | 🐛 2,211 | 🌐 Kotlin | 📅 2026-08-21) `Apache-2.0`
  `TypeScript`, `Swift`, `Kotlin`
* [FluffyChat](https://github.com/krille-chan/fluffychat) ⭐ 3,101 | 🐛 562 | 🌐 Dart | 📅 2026-09-02 - Cute instant messaging
...
* [Matrix CRDT](https://github.com/yousefED/matrix-crdt) ⭐ 784 | 🐛 8 | 🌐 TypeScript | 📅 2024-03-27 - Integrates CRDTs like
  [Yjs](https://github.com/yjs/yjs) ⭐ 22,743 | 🐛 138 | 🌐 JavaScript | 📅 2026-08-06 with Matrix for storage and sync. `MPL-2.0`
  `TypeScript`
...
* [matrix-rust-sdk](https://github.com/matrix-org/matrix-rust-sdk) ⭐ 2,270 | 🐛 317 | 🌐 Rust | 📅 2026-09-03 - A modular

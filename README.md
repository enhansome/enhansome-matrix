...
* [Element](https://element.io) - A glossy client with an emphasis on
  performance and usability. ([Web](https://github.com/vector-im/element-web) ⭐ 13,458 | 🐛 3,774 | 🌐 TypeScript | 📅 2026-09-16,
...
* [FluffyChat](https://github.com/krille-chan/fluffychat) ⭐ 3,131 | 🐛 557 | 🌐 Dart | 📅 2026-09-16 - Cute instant messaging
...
* [Matrix CRDT](https://github.com/yousefED/matrix-crdt) ⭐ 784 | 🐛 8 | 🌐 TypeScript | 📅 2024-03-27 - Integrates CRDTs like
  [Yjs](https://github.com/yjs/yjs) ⭐ 22,802 | 🐛 139 | 🌐 JavaScript | 📅 2026-09-07 with Matrix for storage and sync. `MPL-2.0`
  `TypeScript`
...
* [matrix-rust-sdk](https://github.com/matrix-org/matrix-rust-sdk) ⭐ 2,295 | 🐛 320 | 🌐 Rust | 📅 2026-09-16 - A modular
...
* [matrix-widget-api](https://github.com/matrix-org/matrix-widget-api) ⭐ 95 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-16 - A widget

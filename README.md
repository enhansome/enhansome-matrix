...
* [maubot](https://maubot.xyz) - A plugin-based Matrix bot system with over 30
  plugins for all sorts of things. ([Repo](https://github.com/maubot/maubot) ⭐ 893 | 🐛 84 | 🌐 Python | 📅 2026-07-09,
...
* [Element](https://element.io) - A glossy client with an emphasis on
  performance and usability. ([Web](https://github.com/vector-im/element-web) ⭐ 13,457 | 🐛 3,776 | 🌐 TypeScript | 📅 2026-09-15,
  [iOS](https://github.com/vector-im/element-ios) ⭐ 1,841 | 🐛 1,762 | 🌐 Swift | 📅 2026-09-11,
  [Android](https://github.com/vector-im/element-android) ⭐ 3,731 | 🐛 2,217 | 🌐 Kotlin | 📅 2026-09-10) `Apache-2.0`
  `TypeScript`, `Swift`, `Kotlin`
* [FluffyChat](https://github.com/krille-chan/fluffychat) ⭐ 3,126 | 🐛 556 | 🌐 Dart | 📅 2026-09-15 - Cute instant messaging
...
* [Matrix CRDT](https://github.com/yousefED/matrix-crdt) ⭐ 784 | 🐛 8 | 🌐 TypeScript | 📅 2024-03-27 - Integrates CRDTs like
  [Yjs](https://github.com/yjs/yjs) ⭐ 22,797 | 🐛 139 | 🌐 JavaScript | 📅 2026-09-07 with Matrix for storage and sync. `MPL-2.0`
  `TypeScript`
...
* [matrix-rust-sdk](https://github.com/matrix-org/matrix-rust-sdk) ⭐ 2,294 | 🐛 320 | 🌐 Rust | 📅 2026-09-15 - A modular
...
* [matrix-widget-api](https://github.com/matrix-org/matrix-widget-api) ⭐ 95 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-15 - A widget

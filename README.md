...
* [Matrix Highlight](https://github.com/DanilaFe/matrix-highlight) ⭐ 146 | 🐛 23 | 🌐 TypeScript | 📅 2023-04-23 -
  Matrix-based collaborative web annotation.
  ([Repo](https://github.com/DanilaFe/matrix-highlight) ⭐ 146 | 🐛 23 | 🌐 TypeScript | 📅 2023-04-23,
...
* [Populus-Viewer](https://opentower.github.io/populus-viewer/) - Social
  ...
  ([Repo](https://github.com/opentower/populus-viewer) ⭐ 123 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-23,
...
* [matrix-blog](https://evolved.systems/hosting-a-blog-on-matrix/) - A library
  ...
  blog. ([Repo](https://github.com/evoL/matrix-blog) ⭐ 22 | 🐛 0 | 🌐 TypeScript | 📅 2025-10-18,
...
* [maubot](https://maubot.xyz) - A plugin-based Matrix bot system with over 30
  plugins for all sorts of things. ([Repo](https://github.com/maubot/maubot) ⭐ 896 | 🐛 84 | 🌐 Python | 📅 2026-07-09,
...
* [Element](https://element.io) - A glossy client with an emphasis on
  performance and usability. ([Web](https://github.com/vector-im/element-web) ⭐ 13,495 | 🐛 3,762 | 🌐 TypeScript | 📅 2026-09-22,
  [iOS](https://github.com/vector-im/element-ios) ⭐ 1,840 | 🐛 1,759 | 🌐 Swift | 📅 2026-09-22,
  [Android](https://github.com/vector-im/element-android) ⭐ 3,730 | 🐛 2,213 | 🌐 Kotlin | 📅 2026-09-18) `Apache-2.0`
  `TypeScript`, `Swift`, `Kotlin`
* [FluffyChat](https://github.com/krille-chan/fluffychat) ⭐ 3,141 | 🐛 554 | 🌐 Dart | 📅 2026-09-22 - Cute instant messaging
...
* [Matrix CRDT](https://github.com/yousefED/matrix-crdt) ⭐ 785 | 🐛 8 | 🌐 TypeScript | 📅 2024-03-27 - Integrates CRDTs like
  [Yjs](https://github.com/yjs/yjs) ⭐ 22,823 | 🐛 139 | 🌐 JavaScript | 📅 2026-09-22 with Matrix for storage and sync. `MPL-2.0`
  `TypeScript`
...
* [Collabs](https://github.com/composablesys/collabs/tree/master/collabs#readme) ⭐ 288 | 🐛 15 | 🌐 TypeScript | 📅 2025-03-25 -
...
* [matrix-notepad](https://matrix-notepad.kb1rd.net) - A buggy way to
  ...
  ([Repo](https://github.com/KB1RD/matrix-notepad) ⭐ 70 | 🐛 37 | 🌐 JavaScript | 📅 2023-01-07,
...
* [ODIN](https://odin.syncpoint.io) - Command and Control Information System
  ...
  ([Repo](https://github.com/syncpoint/ODINv2) ⭐ 88 | 🐛 20 | 🌐 JavaScript | 📅 2026-07-06,
...
* [Matrix Limits](https://github.com/jryans/matrix-limits) ⭐ 11 | 🐛 0 | 📅 2021-07-02 - A collection of
  various limits and related factoids about the Matrix specification and
  implementations.

## Moderation

* [LocalModeration for Matrix](https://github.com/berkaygediz/LocalModerationMatrix) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2026-07-28 -
...
* [matrix-rust-sdk](https://github.com/matrix-org/matrix-rust-sdk) ⭐ 2,307 | 🐛 318 | 🌐 Rust | 📅 2026-09-22 - A modular
  ...
  `Apache-2.0` `Rust`
* [matrix.py](https://github.com/Code-Society-Lab/matrixpy) ⭐ 14 | 🐛 25 | 🌐 Python | 📅 2026-09-09 - A simple, developer-friendly
...
* [Matrix Client API](https://github.com/syncpoint/matrix-client-api) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-21 - A
  bespoke and well focused SDK for [ODIN](https://github.com/syncpoint/ODINv2) ⭐ 88 | 🐛 20 | 🌐 JavaScript | 📅 2026-07-06.
  Lightweight and well-structured; may be useful for beginners to explore how
  the Matrix API works. `MIT` `JavaScript`

## Servers

* [Synapse](https://github.com/matrix-org/synapse) ⚠️ Archived - The reference homeserver.
  ([Chat](https://matrix.to/#/#synapse:matrix.org)) `Apache-2.0` `Python`
* [Dendrite](https://github.com/matrix-org/dendrite) ⚠️ Archived - A second-generation
  ...
  `Apache-2.0` `Go`
* [hghs](https://github.com/heusalagroup/hghs#heusalagrouphghs) ⭐ 39 | 🐛 32 | 🌐 TypeScript | 📅 2023-08-12 - Lightweight
...
* [Patience](https://github.com/matrix-org/patience) ⭐ 21 | 🐛 8 | 🌐 TypeScript | 📅 2021-12-06 - Full stack integration
  testing for Matrix clients and servers.
  ([Chat](https://matrix.to/#/#matrix-patience:matrix.org)) `Apache-2.0` `TypeScript`

## Widgets

* [matrix-widget-api](https://github.com/matrix-org/matrix-widget-api) ⭐ 95 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-21 - A widget
...
* [matrix-widget-debug](https://github.com/turt2live/matrix-widget-debug) ⭐ 8 | 🐛 0 | 🌐 HTML | 📅 2021-08-25 - Test
...
* [@rodolpheh's awesome-matrix](https://github.com/rodolpheh/awesome-matrix) ⭐ 68 | 🐛 4 | 📅 2021-04-10 -

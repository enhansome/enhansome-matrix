...
* [Element](https://element.io) - A glossy client with an emphasis on
  performance and usability. ([Web](https://github.com/vector-im/element-web) ⭐ 13,416 | 🐛 3,824 | 🌐 TypeScript | 📅 2026-09-01,
  [iOS](https://github.com/vector-im/element-ios) ⭐ 1,841 | 🐛 1,759 | 🌐 Swift | 📅 2026-06-23,
  [Android](https://github.com/vector-im/element-android) ⭐ 3,724 | 🐛 2,210 | 🌐 Kotlin | 📅 2026-08-21) `Apache-2.0`
  `TypeScript`, `Swift`, `Kotlin`
* [FluffyChat](https://github.com/krille-chan/fluffychat) ⭐ 3,096 | 🐛 562 | 🌐 Dart | 📅 2026-09-01 - Cute instant messaging
...
* [Matrix CRDT](https://github.com/yousefED/matrix-crdt) ⭐ 784 | 🐛 8 | 🌐 TypeScript | 📅 2024-03-27 - Integrates CRDTs like
  [Yjs](https://github.com/yjs/yjs) ⭐ 22,733 | 🐛 138 | 🌐 JavaScript | 📅 2026-08-06 with Matrix for storage and sync. `MPL-2.0`
  `TypeScript`
...
* [matrix-rust-sdk](https://github.com/matrix-org/matrix-rust-sdk) ⭐ 2,266 | 🐛 317 | 🌐 Rust | 📅 2026-09-01 - A modular
  ...
  `Apache-2.0` `Rust`
* [matrix.py](https://github.com/Code-Society-Lab/matrixpy) ⭐ 14 | 🐛 30 | 🌐 Python | 📅 2026-09-01 - A simple, developer-friendly
...
* [matrix-widget-api](https://github.com/matrix-org/matrix-widget-api) ⭐ 95 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-31 - A widget

...
* [Element](https://element.io) - A glossy client with an emphasis on
  performance and usability. ([Web](https://github.com/vector-im/element-web) ⭐ 13,452 | 🐛 3,779 | 🌐 TypeScript | 📅 2026-09-12,
...
* [FluffyChat](https://github.com/krille-chan/fluffychat) ⭐ 3,119 | 🐛 557 | 🌐 Dart | 📅 2026-09-13 - Cute instant messaging
...
* [Matrix CRDT](https://github.com/yousefED/matrix-crdt) ⭐ 784 | 🐛 8 | 🌐 TypeScript | 📅 2024-03-27 - Integrates CRDTs like
  [Yjs](https://github.com/yjs/yjs) ⭐ 22,786 | 🐛 138 | 🌐 JavaScript | 📅 2026-09-07 with Matrix for storage and sync. `MPL-2.0`
  `TypeScript`
...
* [matrix-rust-sdk](https://github.com/matrix-org/matrix-rust-sdk) ⭐ 2,292 | 🐛 324 | 🌐 Rust | 📅 2026-09-13 - A modular

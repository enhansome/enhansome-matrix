...
* [Element](https://element.io) - A glossy client with an emphasis on
  performance and usability. ([Web](https://github.com/vector-im/element-web) ⭐ 13,504 | 🐛 3,701 | 🌐 TypeScript | 📅 2026-09-24,
  [iOS](https://github.com/vector-im/element-ios) ⭐ 1,840 | 🐛 1,759 | 🌐 Swift | 📅 2026-09-24,
  [Android](https://github.com/vector-im/element-android) ⭐ 3,729 | 🐛 2,213 | 🌐 Kotlin | 📅 2026-09-18) `Apache-2.0`
  `TypeScript`, `Swift`, `Kotlin`
* [FluffyChat](https://github.com/krille-chan/fluffychat) ⭐ 3,144 | 🐛 556 | 🌐 Dart | 📅 2026-09-22 - Cute instant messaging
...
* [Matrix CRDT](https://github.com/yousefED/matrix-crdt) ⭐ 785 | 🐛 8 | 🌐 TypeScript | 📅 2024-03-27 - Integrates CRDTs like
  [Yjs](https://github.com/yjs/yjs) ⭐ 22,841 | 🐛 137 | 🌐 JavaScript | 📅 2026-09-23 with Matrix for storage and sync. `MPL-2.0`
  `TypeScript`
...
* [matrix-rust-sdk](https://github.com/matrix-org/matrix-rust-sdk) ⭐ 2,312 | 🐛 313 | 🌐 Rust | 📅 2026-09-24 - A modular
...
* [matrix-widget-api](https://github.com/matrix-org/matrix-widget-api) ⭐ 95 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-23 - A widget

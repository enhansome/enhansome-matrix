...
* [Element](https://element.io) - A glossy client with an emphasis on
  performance and usability. ([Web](https://github.com/vector-im/element-web) ⭐ 13,388 | 🐛 3,835 | 🌐 TypeScript | 📅 2026-08-19,
...
* [FluffyChat](https://github.com/krille-chan/fluffychat) ⭐ 3,060 | 🐛 556 | 🌐 Dart | 📅 2026-08-19 - Cute instant messaging
...
* [Matrix CRDT](https://github.com/yousefED/matrix-crdt) ⭐ 785 | 🐛 8 | 🌐 TypeScript | 📅 2024-03-27 - Integrates CRDTs like
  [Yjs](https://github.com/yjs/yjs) ⭐ 22,372 | 🐛 135 | 🌐 JavaScript | 📅 2026-08-06 with Matrix for storage and sync. `MPL-2.0`
  `TypeScript`
...
* [matrix-rust-sdk](https://github.com/matrix-org/matrix-rust-sdk) ⭐ 2,246 | 🐛 315 | 🌐 Rust | 📅 2026-08-19 - A modular

...
* [Element](https://element.io) - A glossy client with an emphasis on
  performance and usability. ([Web](https://github.com/vector-im/element-web) ⭐ 13,407 | 🐛 3,829 | 🌐 TypeScript | 📅 2026-08-25,
...
* [FluffyChat](https://github.com/krille-chan/fluffychat) ⭐ 3,075 | 🐛 557 | 🌐 Dart | 📅 2026-08-25 - Cute instant messaging
...
* [Matrix CRDT](https://github.com/yousefED/matrix-crdt) ⭐ 784 | 🐛 8 | 🌐 TypeScript | 📅 2024-03-27 - Integrates CRDTs like
  [Yjs](https://github.com/yjs/yjs) ⭐ 22,691 | 🐛 136 | 🌐 JavaScript | 📅 2026-08-06 with Matrix for storage and sync. `MPL-2.0`
  `TypeScript`
...
* [matrix-rust-sdk](https://github.com/matrix-org/matrix-rust-sdk) ⭐ 2,255 | 🐛 314 | 🌐 Rust | 📅 2026-08-25 - A modular
...
* [matrix-widget-api](https://github.com/matrix-org/matrix-widget-api) ⭐ 95 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-25 - A widget
